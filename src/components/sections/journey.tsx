        ...
        <div className="grid gap-12 md:grid-cols-[1.1fr_0.9fr] md:gap-16">
            ...
            <div className="space-y-10">
              {timeline.map((item, i) => (
                ...
                >
                  ...
                  <div className="flex-1 rounded-2xl border border-border/40 bg-card/30 p-5 backdrop-blur-md">
          ...
          <div className="space-y-8">
            <motion.div
              ...
              viewport={{ once: true, margin: "-60px" }}
              transition={{ duration: 0.5 }}
              className="rounded-2xl border border-border/40 bg-card/30 p-6 backdrop-blur-md"
            >
              ...
              <div className="space-y-3">
                {certifications.map((c) => (
                  <div
                    key={c.title}
                    className="group flex items-center justify-between gap-4 border-b border-border/30 pb-3 last:border-0"
                  >
                    <div>
