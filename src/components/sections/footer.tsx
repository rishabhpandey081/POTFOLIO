  ...
  return (
    <footer className="relative mt-10 border-t border-border/40">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="grid gap-10 md:grid-cols-[1fr_1fr] md:gap-16">
          <div>
            ...
            <a
              ...
              className="mt-6 inline-block font-display text-lg font-medium tracking-tight link-underline"
            >
              {profile.email}
            </a>
          </div>
        ...
        <div className="mt-12 flex flex-col-reverse items-center justify-between gap-4 border-t border-border/40 py-6 sm:flex-row">
