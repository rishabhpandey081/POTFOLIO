  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 35% 35%, oklch(0.72 0.19 18 / 0.7), oklch(0.7 0.18 350 / 0.3) 40%, transparent 70%)",
          borderRadius: "50%",
          filter: "blur(20px)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.9 0.12 20 / 0.9), oklch(0.72 0.19 18 / 0.4) 50%, transparent 80%)",
          borderRadius: "50%",
          filter: "blur(8px)",
